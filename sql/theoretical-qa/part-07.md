# SQL — 175 Theoretical Q&A — Part 7

Original interview answers.

<!-- item -->
## 151. **Question:** What production evidence validates **partitioning** in OLTP?
...
<!-- item -->
## 152. **Question:** How do you make **materialized views** in a warehouse?
...
<!-- item -->
## 153. **Question:** How would you explain **SCD** in a lakehouse?
...
<!-- item -->
## 154. **Question:** When would you choose **NULL semantics** in an incremental pipeline?
...
<!-- item -->
## 155. **Question:** How would you troubleshoot **set operations** in a high-concurrency dashboard?
...
<!-- item -->
## 156. **Question:** What is the main risk of **data types** in OLTP?
...
<!-- item -->
## 157. **Question:** How would you optimize **cardinality** in a warehouse?
...
<!-- item -->
## 158. **Question:** How would you test **aggregation** in a lakehouse?
...
<!-- item -->
## 159. **Question:** What production evidence validates **recursive SQL** in an incremental pipeline?
...
<!-- item -->
## 160. **Question:** How do you make **MERGE** in a high-concurrency dashboard?
...
<!-- item -->
## 161. **Question:** How would you explain **joins** in OLTP?
...
<!-- item -->
## 162. **Question:** When would you choose **window functions** in a warehouse?
...
<!-- item -->
## 163. **Question:** How would you troubleshoot **CTEs** in a lakehouse?
...
<!-- item -->
## 164. **Question:** What is the main risk of **subqueries** in an incremental pipeline?
...
<!-- item -->
## 165. **Question:** How would you optimize **indexes** in a high-concurrency dashboard?
...
<!-- item -->
## 166. **Question:** How would you test **query plans** in OLTP?
...
<!-- item -->
## 167. **Question:** What production evidence validates **transactions** in a warehouse?
...
<!-- item -->
## 168. **Question:** How do you make **isolation** in a lakehouse?
...
<!-- item -->
## 169. **Question:** How would you explain **normalization** in an incremental pipeline?
...
<!-- item -->
## 170. **Question:** When would you choose **constraints** in a high-concurrency dashboard?
...
<!-- item -->
## 171. **Question:** How would you troubleshoot **partitioning** in OLTP?
...
<!-- item -->
## 172. **Question:** What is the main risk of **materialized views** in a warehouse?

**Answer:** The main risk is treating a context-dependent technique as a default. Control it with explicit assumptions, tests, monitoring, and a rollback path. For materialized views, document the input contract, expected scale, failure behavior, and recovery procedure. In a warehouse, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 173. **Question:** How would you optimize **SCD** in a lakehouse?

**Answer:** Measure the baseline, identify the dominant cost, apply the narrowest effective change, and compare latency, correctness, and cost after the change. For SCD, document the input contract, expected scale, failure behavior, and recovery procedure. In a lakehouse, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 174. **Question:** How would you test **NULL semantics** in an incremental pipeline?
...
<!-- item -->
## 175. **Question:** What production evidence validates **set operations** in a high-concurrency dashboard?
