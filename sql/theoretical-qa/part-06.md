# SQL — 175 Theoretical Q&A — Part 6

Original interview answers.

<!-- item -->
## 126. **Question:** How would you test **query plans** in OLTP?
...
<!-- item -->
## 127. **Question:** What production evidence validates **transactions** in a warehouse?
...
<!-- item -->
## 128. **Question:** How do you make **isolation** in a lakehouse?
...
<!-- item -->
## 129. **Question:** How would you explain **normalization** in an incremental pipeline?
...
<!-- item -->
## 130. **Question:** When would you choose **constraints** in a high-concurrency dashboard?
...
<!-- item -->
## 131. **Question:** How would you troubleshoot **partitioning** in OLTP?
...
<!-- item -->
## 132. **Question:** What is the main risk of **materialized views** in a warehouse?
...
<!-- item -->
## 133. **Question:** How would you optimize **SCD** in a lakehouse?
...
<!-- item -->
## 134. **Question:** How would you test **NULL semantics** in an incremental pipeline?
...
<!-- item -->
## 135. **Question:** What production evidence validates **set operations** in a high-concurrency dashboard?
...
<!-- item -->
## 136. **Question:** How do you make **data types** in OLTP?
...
<!-- item -->
## 137. **Question:** How would you explain **cardinality** in a warehouse?
...
<!-- item -->
## 138. **Question:** When would you choose **aggregation** in a lakehouse?
...
<!-- item -->
## 139. **Question:** How would you troubleshoot **recursive SQL** in an incremental pipeline?
...
<!-- item -->
## 140. **Question:** What is the main risk of **MERGE** in a high-concurrency dashboard?
...
<!-- item -->
## 141. **Question:** How would you optimize **joins** in OLTP?

**Answer:** Measure the baseline, identify the dominant cost, apply the narrowest effective change, and compare latency, correctness, and cost after the change. For joins, document the input contract, expected scale, failure behavior, and recovery procedure. In OLTP, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 142. **Question:** How would you test **window functions** in a warehouse?
...
<!-- item -->
## 143. **Question:** What production evidence validates **CTEs** in a lakehouse?
...
<!-- item -->
## 144. **Question:** How do you make **subqueries** in an incremental pipeline?
...
<!-- item -->
## 145. **Question:** How would you explain **indexes** in a high-concurrency dashboard?
...
<!-- item -->
## 146. **Question:** When would you choose **query plans** in OLTP?
...
<!-- item -->
## 147. **Question:** How would you troubleshoot **transactions** in a warehouse?
...
<!-- item -->
## 148. **Question:** What is the main risk of **isolation** in a lakehouse?
...
<!-- item -->
## 149. **Question:** How would you optimize **normalization** in an incremental pipeline?
...
<!-- item -->
## 150. **Question:** How would you test **constraints** in a high-concurrency dashboard?
