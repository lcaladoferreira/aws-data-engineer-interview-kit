# AWS Certified Cloud Practitioner — 700 Original Practice Q&A — Part 20

Original study questions—not exam dumps or recalled exam content. Verify changing details against AWS documentation.

<!-- item -->
## 476. **Question:** What is the main risk of **EC2** in a startup?
...
<!-- item -->
## 477. **Question:** How would you optimize **RDS** in an enterprise?
...
<!-- item -->
## 478. **Question:** How would you test **Lambda** in a regulated workload?
...
<!-- item -->
## 479. **Question:** What production evidence validates **CloudFront** in a multi-account environment?
...
<!-- item -->
## 480. **Question:** How do you make **CloudWatch** in a disaster-recovery design?
...
<!-- item -->
## 481. **Question:** How would you explain **shared responsibility** in a startup?
...
<!-- item -->
## 482. **Question:** When would you choose **IAM** in an enterprise?
...
<!-- item -->
## 483. **Question:** How would you troubleshoot **billing** in a regulated workload?
...
<!-- item -->
## 484. **Question:** What is the main risk of **support plans** in a multi-account environment?
...
<!-- item -->
## 485. **Question:** How would you optimize **global infrastructure** in a disaster-recovery design?
...
<!-- item -->
## 486. **Question:** How would you test **Well-Architected** in a startup?
...
<!-- item -->
## 487. **Question:** What production evidence validates **S3** in an enterprise?
...
<!-- item -->
## 488. **Question:** How do you make **EC2** in a regulated workload?
...
<!-- item -->
## 489. **Question:** How would you explain **RDS** in a multi-account environment?
...
<!-- item -->
## 490. **Question:** When would you choose **Lambda** in a disaster-recovery design?
...
<!-- item -->
## 491. **Question:** How would you troubleshoot **CloudFront** in a startup?
...
<!-- item -->
## 492. **Question:** What is the main risk of **CloudWatch** in an enterprise?
...
<!-- item -->
## 493. **Question:** How would you optimize **shared responsibility** in a regulated workload?

**Answer:** Measure the baseline, identify the dominant cost, apply the narrowest effective change, and compare latency, correctness, and cost after the change. For shared responsibility, document the input contract, expected scale, failure behavior, and recovery procedure. In a regulated workload, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 494. **Question:** How would you test **IAM** in a multi-account environment?
...
<!-- item -->
## 495. **Question:** What production evidence validates **billing** in a disaster-recovery design?
...
<!-- item -->
## 496. **Question:** How do you make **support plans** in a startup?
...
<!-- item -->
## 497. **Question:** How would you explain **global infrastructure** in an enterprise?
...
<!-- item -->
## 498. **Question:** When would you choose **Well-Architected** in a regulated workload?
...
<!-- item -->
## 499. **Question:** How would you troubleshoot **S3** in a multi-account environment?
...
<!-- item -->
## 500. **Question:** What is the main risk of **EC2** in a disaster-recovery design?
