# AWS Certified Cloud Practitioner — 700 Original Practice Q&A — Part 5

Original study questions—not exam dumps or recalled exam content. Verify changing details against AWS documentation.

<!-- item -->
## 101. **Question:** How would you optimize **global infrastructure** in a startup?
...
<!-- item -->
## 102. **Question:** How would you test **Well-Architected** in an enterprise?
...
<!-- item -->
## 103. **Question:** What production evidence validates **S3** in a regulated workload?
...
<!-- item -->
## 104. **Question:** How do you make **EC2** in a multi-account environment?
...
<!-- item -->
## 105. **Question:** How would you explain **RDS** in a disaster-recovery design?
...
<!-- item -->
## 106. **Question:** When would you choose **Lambda** in a startup?
...
<!-- item -->
## 107. **Question:** How would you troubleshoot **CloudFront** in an enterprise?
...
<!-- item -->
## 108. **Question:** What is the main risk of **CloudWatch** in a regulated workload?
...
<!-- item -->
## 109. **Question:** How would you optimize **shared responsibility** in a multi-account environment?
...
<!-- item -->
## 110. **Question:** How would you test **IAM** in a disaster-recovery design?
...
<!-- item -->
## 111. **Question:** What production evidence validates **billing** in a startup?
...
<!-- item -->
## 112. **Question:** How do you make **support plans** in an enterprise?
...
<!-- item -->
## 113. **Question:** How would you explain **global infrastructure** in a regulated workload?
...
<!-- item -->
## 114. **Question:** When would you choose **Well-Architected** in a multi-account environment?
...
<!-- item -->
## 115. **Question:** How would you troubleshoot **S3** in a disaster-recovery design?
...
<!-- item -->
## 119. **Question:** What production evidence validates **CloudFront** in a multi-account environment?
...
<!-- item -->
## 120. **Question:** How do you make **CloudWatch** in a disaster-recovery design?
...
<!-- item -->
## 121. **Question:** How would you explain **shared responsibility** in a startup?

**Answer:** Define the concept first, state its trade-offs, then connect it to an observable production decision. For shared responsibility, document the input contract, expected scale, failure behavior, and recovery procedure. In a startup, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 122. **Question:** When would you choose **IAM** in an enterprise?
...
<!-- item -->
## 123. **Question:** How would you troubleshoot **billing** in a regulated workload?
...
<!-- item -->
## 124. **Question:** What is the main risk of **support plans** in a multi-account environment?
...
<!-- item -->
## 125. **Question:** How would you optimize **global infrastructure** in a disaster-recovery design?
