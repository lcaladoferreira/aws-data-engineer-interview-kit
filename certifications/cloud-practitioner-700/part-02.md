# AWS Certified Cloud Practitioner — 700 Original Practice Q&A — Part 2

Original study questions—not exam dumps or recalled exam content. Verify changing details against AWS documentation.

<!-- item -->
## 26. **Question:** When would you choose **IAM** in a startup?
...
<!-- item -->
## 27. **Question:** How would you troubleshoot **billing** in an enterprise?
...
<!-- item -->
## 28. **Question:** What is the main risk of **support plans** in a regulated workload?
...
<!-- item -->
## 29. **Question:** How would you optimize **global infrastructure** in a multi-account environment?
...
<!-- item -->
## 30. **Question:** How would you test **Well-Architected** in a disaster-recovery design?
...
<!-- item -->
## 31. **Question:** What production evidence validates **S3** in a startup?
...
<!-- item -->
## 32. **Question:** How do you make **EC2** in an enterprise?
...
<!-- item -->
## 33. **Question:** How would you explain **RDS** in a regulated workload?
...
<!-- item -->
## 34. **Question:** When would you choose **Lambda** in a multi-account environment?
...
<!-- item -->
## 35. **Question:** How would you troubleshoot **CloudFront** in a disaster-recovery design?
...
<!-- item -->
## 36. **Question:** What is the main risk of **CloudWatch** in a startup?
...
<!-- item -->
## 37. **Question:** How would you optimize **shared responsibility** in an enterprise?

**Answer:** Measure the baseline, identify the dominant cost, apply the narrowest effective change, and compare latency, correctness, and cost after the change. For shared responsibility, document the input contract, expected scale, failure behavior, and recovery procedure. In an enterprise, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 38. **Question:** How would you test **IAM** in a regulated workload?
...
<!-- item -->
## 39. **Question:** What production evidence validates **billing** in a multi-account environment?
...
<!-- item -->
## 40. **Question:** How do you make **support plans** in a disaster-recovery design?
...
<!-- item -->
## 41. **Question:** How would you explain **global infrastructure** in a startup?
...
<!-- item -->
## 42. **Question:** When would you choose **Well-Architected** in an enterprise?
...
<!-- item -->
## 43. **Question:** How would you troubleshoot **S3** in a regulated workload?
...
<!-- item -->
## 44. **Question:** What is the main risk of **EC2** in a multi-account environment?
...
<!-- item -->
## 45. **Question:** How would you optimize **RDS** in a disaster-recovery design?
...
<!-- item -->
## 46. **Question:** How would you test **Lambda** in a startup?
...
<!-- item -->
## 47. **Question:** What production evidence validates **CloudFront** in an enterprise?
...
<!-- item -->
## 48. **Question:** How do you make **CloudWatch** in a regulated workload?
...
<!-- item -->
## 49. **Question:** How would you explain **shared responsibility** in a multi-account environment?

**Answer:** Define the concept first, state its trade-offs, then connect it to an observable production decision. For shared responsibility, document the input contract, expected scale, failure behavior, and recovery procedure. In a multi-account environment, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 50. **Question:** When would you choose **IAM** in a disaster-recovery design?
