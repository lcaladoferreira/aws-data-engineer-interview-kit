# AWS Certified Cloud Practitioner — 700 Original Practice Q&A — Part 1

Original study questions—not exam dumps or recalled exam content. Verify changing details against AWS documentation.

<!-- item -->
## 1. **Question:** How would you explain **shared responsibility** in a startup?
...
<!-- item -->
## 2. **Question:** When would you choose **IAM** in an enterprise?
...
<!-- item -->
## 3. **Question:** How would you troubleshoot **billing** in a regulated workload?
...
<!-- item -->
## 4. **Question:** What is the main risk of **support plans** in a multi-account environment?
...
<!-- item -->
## 5. **Question:** How would you optimize **global infrastructure** in a disaster-recovery design?
...
<!-- item -->
## 6. **Question:** How would you test **Well-Architected** in a startup?
...
<!-- item -->
## 7. **Question:** What production evidence validates **S3** in an enterprise?
...
<!-- item -->
## 8. **Question:** How do you make **EC2** in a regulated workload?
...
<!-- item -->
## 9. **Question:** How would you explain **RDS** in a multi-account environment?
...
<!-- item -->
## 10. **Question:** When would you choose **Lambda** in a disaster-recovery design?
...
<!-- item -->
## 11. **Question:** How would you troubleshoot **CloudFront** in a startup?
...
<!-- item -->
## 12. **Question:** What is the main risk of **CloudWatch** in an enterprise?
...
<!-- item -->
## 13. **Question:** How would you optimize **shared responsibility** in a regulated workload?

**Answer:** Measure the baseline, identify the dominant cost, apply the narrowest effective change, and compare latency, correctness, and cost after the change. For shared responsibility, document the input contract, expected scale, failure behavior, and recovery procedure. In a regulated workload, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 14. **Question:** How would you test **IAM** in a multi-account environment?
...
<!-- item -->
## 15. **Question:** What production evidence validates **billing** in a disaster-recovery design?
...
<!-- item -->
## 16. **Question:** How do you make **support plans** in a startup?
...
<!-- item -->
## 17. **Question:** How would you explain **global infrastructure** in an enterprise?
...
<!-- item -->
## 18. **Question:** When would you choose **Well-Architected** in a regulated workload?
...
<!-- item -->
## 19. **Question:** How would you troubleshoot **S3** in a multi-account environment?
...
<!-- item -->
## 20. **Question:** What is the main risk of **EC2** in a disaster-recovery design?
...
<!-- item -->
## 23. **Question:** What production evidence validates **CloudFront** in a regulated workload?
...
<!-- item -->
## 24. **Question:** How do you make **CloudWatch** in a multi-account environment?
...
<!-- item -->
## 25. **Question:** How would you explain **shared responsibility** in a disaster-recovery design?
