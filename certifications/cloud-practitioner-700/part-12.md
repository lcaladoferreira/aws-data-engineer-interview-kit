# AWS Certified Cloud Practitioner — 700 Original Practice Q&A — Part 12

Original study questions—not exam dumps or recalled exam content. Verify changing details against AWS documentation.

<!-- item -->
## 276. **Question:** What is the main risk of **CloudWatch** in a startup?
...
<!-- item -->
## 277. **Question:** How would you optimize **shared responsibility** in an enterprise?
...
<!-- item -->
## 278. **Question:** How would you test **IAM** in a regulated workload?
...
<!-- item -->
## 279. **Question:** What production evidence validates **billing** in a multi-account environment?
...
<!-- item -->
## 280. **Question:** How do you make **support plans** in a disaster-recovery design?
...
<!-- item -->
## 281. **Question:** How would you explain **global infrastructure** in a startup?
...
<!-- item -->
## 282. **Question:** When would you choose **Well-Architected** in an enterprise?
...
<!-- item -->
## 283. **Question:** How would you troubleshoot **S3** in a regulated workload?
...
<!-- item -->
## 284. **Question:** What is the main risk of **EC2** in a multi-account environment?
...
<!-- item -->
## 285. **Question:** How would you optimize **RDS** in a disaster-recovery design?
...
<!-- item -->
## 286. **Question:** How would you test **Lambda** in a startup?
...
<!-- item -->
## 287. **Question:** What production evidence validates **CloudFront** in an enterprise?
...
<!-- item -->
## 288. **Question:** How do you make **CloudWatch** in a regulated workload?
...
<!-- item -->
## 289. **Question:** How would you explain **shared responsibility** in a multi-account environment?

**Answer:** Define the concept first, state its trade-offs, then connect it to an observable production decision. For shared responsibility, document the input contract, expected scale, failure behavior, and recovery procedure. In a multi-account environment, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 290. **Question:** When would you choose **IAM** in a disaster-recovery design?
...
<!-- item -->
## 291. **Question:** How would you troubleshoot **billing** in a startup?
...
<!-- item -->
## 292. **Question:** What is the main risk of **support plans** in an enterprise?
...
<!-- item -->
## 293. **Question:** How would you optimize **global infrastructure** in a regulated workload?
...
<!-- item -->
## 294. **Question:** How would you test **Well-Architected** in a multi-account environment?
...
<!-- item -->
## 295. **Question:** What production evidence validates **S3** in a disaster-recovery design?
...
<!-- item -->
## 296. **Question:** How do you make **EC2** in a startup?
...
<!-- item -->
## 297. **Question:** How would you explain **RDS** in an enterprise?
...
<!-- item -->
## 298. **Question:** When would you choose **Lambda** in a regulated workload?
...
<!-- item -->
## 299. **Question:** How would you troubleshoot **CloudFront** in a multi-account environment?
...
<!-- item -->
## 300. **Question:** What is the main risk of **CloudWatch** in a disaster-recovery design?
