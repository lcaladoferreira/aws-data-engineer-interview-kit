# AWS Solutions Architect – Associate — 1000 Original Practice Q&A — Part 36

Original study questions—not exam dumps or recalled exam content. Verify changing details against AWS documentation.

<!-- item -->
## 876. **Question:** What is the main risk of **databases** in a startup?
...
<!-- item -->
## 877. **Question:** How would you optimize **serverless** in an enterprise?
...
<!-- item -->
## 878. **Question:** How would you test **migration** in a regulated workload?
...
<!-- item -->
## 879. **Question:** What production evidence validates **decoupling** in a multi-account environment?
...
<!-- item -->
## 880. **Question:** How do you make **observability** in a disaster-recovery design?
...
<!-- item -->
## 881. **Question:** How would you explain **resilience** in a startup?
...
<!-- item -->
## 882. **Question:** When would you choose **performance** in an enterprise?
...
<!-- item -->
## 883. **Question:** How would you troubleshoot **security** in a regulated workload?
...
<!-- item -->
## 884. **Question:** What is the main risk of **cost** in a multi-account environment?
...
<!-- item -->
## 885. **Question:** How would you optimize **networking** in a disaster-recovery design?
...
<!-- item -->
## 886. **Question:** How would you test **storage** in a startup?
...
<!-- item -->
## 887. **Question:** What production evidence validates **databases** in an enterprise?
...
<!-- item -->
## 888. **Question:** How do you make **serverless** in a regulated workload?
...
<!-- item -->
## 889. **Question:** How would you explain **migration** in a multi-account environment?
...
<!-- item -->
## 890. **Question:** When would you choose **decoupling** in a disaster-recovery design?
...
<!-- item -->
## 891. **Question:** How would you troubleshoot **observability** in a startup?
...
<!-- item -->
## 892. **Question:** What is the main risk of **resilience** in an enterprise?
...
<!-- item -->
## 893. **Question:** How would you optimize **performance** in a regulated workload?
...
<!-- item -->
## 894. **Question:** How would you test **security** in a multi-account environment?
...
<!-- item -->
## 895. **Question:** What production evidence validates **cost** in a disaster-recovery design?
...
<!-- item -->
## 896. **Question:** How do you make **networking** in a startup?
...
<!-- item -->
## 897. **Question:** How would you explain **storage** in an enterprise?
...
<!-- item -->
## 898. **Question:** When would you choose **databases** in a regulated workload?
...
<!-- item -->
## 899. **Question:** How would you troubleshoot **serverless** in a multi-account environment?
...
<!-- item -->
## 900. **Question:** What is the main risk of **migration** in a disaster-recovery design?
