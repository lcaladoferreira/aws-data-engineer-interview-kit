# PySpark — 160 Theoretical Q&A — Part 2

Original interview answers.

<!-- item -->
## 26. **Question:** When would you choose **shuffle** in a 10 TB batch?
...
<!-- item -->
## 27. **Question:** How would you troubleshoot **partitioning** in a streaming job?
...
<!-- item -->
## 28. **Question:** What is the main risk of **AQE** in AWS Glue?
...
<!-- item -->
## 29. **Question:** How would you optimize **broadcast joins** in Amazon EMR?
...
<!-- item -->
## 30. **Question:** How would you test **skew** in a lakehouse?
...
<!-- item -->
## 31. **Question:** What production evidence validates **caching** in a 10 TB batch?
...
<!-- item -->
## 32. **Question:** How do you make **checkpointing** in a streaming job?
...
<!-- item -->
## 33. **Question:** How would you explain **Structured Streaming** in AWS Glue?
...
<!-- item -->
## 34. **Question:** When would you choose **watermarks** in Amazon EMR?
...
<!-- item -->
## 35. **Question:** How would you troubleshoot **state** in a lakehouse?
...
<!-- item -->
## 36. **Question:** What is the main risk of **UDFs** in a 10 TB batch?
...
<!-- item -->
## 37. **Question:** How would you optimize **Pandas UDFs** in a streaming job?

**Answer:** Measure the baseline, identify the dominant cost, apply the narrowest effective change, and compare latency, correctness, and cost after the change. For Pandas UDFs, document the input contract, expected scale, failure behavior, and recovery procedure. In a streaming job, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 38. **Question:** How would you test **schema evolution** in AWS Glue?
...
<!-- item -->
## 39. **Question:** What production evidence validates **Parquet** in Amazon EMR?
...
<!-- item -->
## 40. **Question:** How do you make **Delta Lake** in a lakehouse?
...
<!-- item -->
## 41. **Question:** How would you explain **lazy evaluation** in a 10 TB batch?
...
<!-- item -->
## 42. **Question:** When would you choose **transformations** in a streaming job?
...
<!-- item -->
## 43. **Question:** How would you troubleshoot **actions** in AWS Glue?
...
<!-- item -->
## 44. **Question:** What is the main risk of **Catalyst** in Amazon EMR?
...
<!-- item -->
## 45. **Question:** How would you optimize **Tungsten** in a lakehouse?
...
<!-- item -->
## 46. **Question:** How would you test **shuffle** in a 10 TB batch?
...
<!-- item -->
## 47. **Question:** What production evidence validates **partitioning** in a streaming job?
...
<!-- item -->
## 48. **Question:** How do you make **AQE** in AWS Glue?
...
<!-- item -->
## 49. **Question:** How would you explain **broadcast joins** in Amazon EMR?
...
<!-- item -->
## 50. **Question:** When would you choose **skew** in a lakehouse?
