# PySpark — 160 Theoretical Q&A — Part 1

Original interview answers.

<!-- item -->
## 1. **Question:** How would you explain **lazy evaluation** in a 10 TB batch?
...
<!-- item -->
## 2. **Question:** When would you choose **transformations** in a streaming job?
...
<!-- item -->
## 3. **Question:** How would you troubleshoot **actions** in AWS Glue?
...
<!-- item -->
## 4. **Question:** What is the main risk of **Catalyst** in Amazon EMR?
...
<!-- item -->
## 5. **Question:** How would you optimize **Tungsten** in a lakehouse?
...
<!-- item -->
## 6. **Question:** How would you test **shuffle** in a 10 TB batch?
...
<!-- item -->
## 7. **Question:** What production evidence validates **partitioning** in a streaming job?
...
<!-- item -->
## 8. **Question:** How do you make **AQE** in AWS Glue?
...
<!-- item -->
## 9. **Question:** How would you explain **broadcast joins** in Amazon EMR?
...
<!-- item -->
## 10. **Question:** When would you choose **skew** in a lakehouse?
...
<!-- item -->
## 11. **Question:** How would you troubleshoot **caching** in a 10 TB batch?
...
<!-- item -->
## 12. **Question:** What is the main risk of **checkpointing** in a streaming job?

**Answer:** The main risk is treating a context-dependent technique as a default. Control it with explicit assumptions, tests, monitoring, and a rollback path. For checkpointing, document the input contract, expected scale, failure behavior, and recovery procedure. In a streaming job, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 13. **Question:** How would you optimize **Structured Streaming** in AWS Glue?
...
<!-- item -->
## 14. **Question:** How would you test **watermarks** in Amazon EMR?
...
<!-- item -->
## 15. **Question:** What production evidence validates **state** in a lakehouse?
...
<!-- item -->
## 16. **Question:** How do you make **UDFs** in a 10 TB batch?
...
<!-- item -->
## 17. **Question:** How would you explain **Pandas UDFs** in a streaming job?
...
<!-- item -->
## 18. **Question:** When would you choose **schema evolution** in AWS Glue?
...
<!-- item -->
## 19. **Question:** How would you troubleshoot **Parquet** in Amazon EMR?
...
<!-- item -->
## 20. **Question:** What is the main risk of **Delta Lake** in a lakehouse?
...
<!-- item -->
## 21. **Question:** How would you optimize **lazy evaluation** in a 10 TB batch?
...
<!-- item -->
## 22. **Question:** How would you test **transformations** in a streaming job?
...
<!-- item -->
## 23. **Question:** What production evidence validates **actions** in AWS Glue?
...
<!-- item -->
## 24. **Question:** How do you make **Catalyst** in Amazon EMR?

**Answer:** Make ownership, idempotency, retries, observability, security, and cost limits explicit before scaling. For Catalyst, document the input contract, expected scale, failure behavior, and recovery procedure. In Amazon EMR, confirm the decision with a small reproducible test and retain the evidence an interviewer can inspect.

<!-- item -->
## 25. **Question:** How would you explain **Tungsten** in a lakehouse?
